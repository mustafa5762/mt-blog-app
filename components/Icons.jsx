...
function Icons({id, openit, likess, blog}) {
    ...
    <div>
        <div className="Icons">
            ...
            <motion.div initial={{scale:0}} animate={{scale:1}} transition={{duration:0.3,type:'spring',stiffness:200}} onClick={unLike} className="Icon" style={{color: '#dc2626'}}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="whwh selected">
            ...
            </div>
            {
                ...
                <motion.div initial={{scale:0}} animate={{scale:1}} transition={{duration:0.3,type:'spring',stiffness:200}} onClick={() => removeSaved(blog._id)} className="Icon">
                    <svg style={{color:'#059669'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="whwh selected2">
                        <path fillRule="evenodd" d="M6.32 2.577a49.255 49.255 0 0111.36 0c1.497.174 2.57 1.46 2.57 2.93V21a.75.75 0 01-1.085.67L12 18.089l-7.165 3.583A.75.75 0 013.75 21V5.507c0-1.47 1.073-2.756 2.57-2.93z" clipRule="evenodd" />
                    </svg>
                </motion.div>
                :
                <div onClick={() => addtoSaved(blog)} className="Icon i3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="whwh">
