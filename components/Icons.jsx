  ...
  return (
    <div>
        <div className="flex p-1">
            ...
            <motion.div initial={{scale:0}} animate={{scale:1}} transition={{duration:0.3,type:'spring',stiffness:200}} onClick={unLike} className="flex cursor-pointer items-center text-pink-700 p-3 m-1">
            ...
            :
            <div onClick={Like} className="flex cursor-pointer items-center text-slate-600 p-3 m-1 hover:bg-pink-100 hover:text-pink-900 rounded-full transition">
